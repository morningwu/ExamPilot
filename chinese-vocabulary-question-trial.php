     ...
     <div id="wrapper">
		...
		<div class="container center">
			<div class="row-fluid">
				...
				<div class="span12">
                	<div id="inner_title">
                        <h2 class="text-center"><?php echo $getTitle ." ( ".$level. " ) ";?></h2>
                        
                        <div class="text-center">
                            <a id ="flat-btn" class="flat-button flat-button-2" href="chinese-vocabulary-trial.php?level=<?php echo $_GET['level'];?>">&larr; 返回</a> 
                        </div>
                    </div>
				</div>
			</div><!--/row-->
            ...
            <div class="container center">
                ...
                <!-- Assessment Content Start -->
                    ...
                    <div class="tabbable"> 
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab1" data-toggle="tab"><strong>題目簡介</strong></a></li>
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        <h2 align="center"><span class="font-orange"><?php if(isset($_POST['submit'])){echo "<h1>你既成績"."</h1>" ;}else{echo "任務 " . $missionId. " : ". $getTitle;}?></span></h2><hr/>
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(empty($_POST[$id])){
                                    ...
                                    echo "<p align='center'><a class='btn blue-btn' href='chinese-vocabulary-question-trial.php?id=".$missionId.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType. '&level='.$level."'>答多次先</a></p>";
                                    exit();
                                }
