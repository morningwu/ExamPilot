...

{
    ...
    $questionMaths          = mysql_query("SELECT DISTINCT (`mission_id`),`question_type`,`title` FROM `questions_maths` WHERE `subject` = 'Math' AND `learning_area` = 'AppliedQuestions' AND `level` = '$studentLevelGet'");
     ...
     <div id="wrapper">
        ...
        <div class="container">
            <div class="row-fluid">
                <div class="span12">
                     <div id="inner_title">
                    <h2 class="text-center">數學 ( 應用題 )</h2> 
                    
                    <div class="text-center">
                       <a class="flat-button flat-button-2" href="maths.php?level=<?php echo $studentLevelGet;?>"> &larr; Back</a>  
                    </div>
                </div>
        ...
        <div id="content">
            <div class="container">
                ...
                while ($fetch_questions = mysql_fetch_assoc($questionMaths)){
                    ...
                    $attemptCount               =   mysql_query("SELECT `title` FROM `answered_questions` WHERE `student_name` = '{$student_name}' AND `mission_id` = '$missionId' AND `subject` = 'Math' AND `learning_area` = 'AppliedQuestions'");
                        ...
                        <img src="_assets/img/english/grammar/grammar-icon-'.$photoNum.'.png" alt="English-Grammar-Icon"/>
                            ...
                            <table>
                                ...
                                <div class="btn-container">
                                    <a class="flat-button flat-btn-round-3" href="math-applied-questions.php?id='.$missionId.'&level='.$studentLevelGet.'&assessmenttitle='.$trimmed_title.'&questiontype='.$trimmed_questionType.'">做練習 &rarr;</a> 
                                </div>
                            </div>
                    </div>';
