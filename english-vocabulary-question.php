    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span12">
                    <div id="inner_title">
                        <h2 class="text-center">English Vocabulary <?php echo " ( ".$level . " ) ";?></h2>
                 
                        <div class="text-center">
                            <a class="flat-button flat-button-2" href="english-vocabulary-new.php?level=<?php echo $studentLevelGet;?>">&larr; Back</a> 
                        </div>
                    </div>
                </div>
            </div><!--/row-->
        ...
        <div id="content">
            <div class="container center">
                ...
                <!-- Assessment Content Start -->
                      ...
                      <?php
                      $photoNum = $missionId;
                      echo '<img src="_assets/img/english/grammar/grammar-icon-'.$photoNum.'.png" alt="English-Vocabulary-Icon"/><hr/>';
                      ?>
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                           ...
                           include('question/result-message-box-english.php');
                            ...
                            if(isset($_POST['submit'])){ 
                                if(empty($_POST[$id])){
                                    ...
                                    echo "<p align='center'><a class='btn blue-btn' href='english-vocabulary-question.php?id=".$missionId.'&level='.$studentLevelGet.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType."'>Try Again</a></p>";
                                    exit();
                                }
                            ...
                            <tr>
                                ...
                                if($score > $total*$passing_rate){
                                    echo "<span class='font-green'>You've passed!</span></td></tr>".
                                "<tr>
                           ...
                           "<tr>
                            ...
                            <div align='center'>
                                <a class='btn blue-btn' href='english-vocabulary-question.php?id=".$missionId.'&level='.$studentLevelGet.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType."'>Try Again</a>
                            <a href='english-vocabulary-new.php?level=".$studentLevelGet."' class='btn blue-btn' name='next'>Other Missions</a>
                            </div>
                            ";
                            //echo ' </div>';
