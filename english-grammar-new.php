...
if(isset($_SESSION['studentEmail']))
{
    ...
    $questionEnglish        = mysql_query("SELECT DISTINCT (`mission_id`),`question_type`,`title` FROM `questions` WHERE `subject` = 'English' AND `learning_area` = 'Grammar' AND `level` = '$studentLevelGet'");
	...
	<body>
		...
		<div class="container center">
			<div class="row-fluid">
				<div class="span12">
                    <div id="inner_title">
                    <h2 class="text-center">English Grammar<? if(isset($_SESSION['student_name'])){echo " ( " . $row['student_level'] ." ) "; }?></h2> 
                        ...
                        <img src="_assets/img/english/grammar/grammar-icon-'.$photoNum.'.png" alt="English-Grammar-Icon"/>
                            ...
                            <table>
                                ...
                                <div class="btn-container">
                                    <a id ="flat-btn" class="flat-button flat-btn-round-3" href="english-grammar-question.php?level='.$studentLevelGet.'&id='.$missionId.'&assessmenttitle='.$trimmed_title.'&questiontype='.$trimmed_questionType.'">Learn &rarr;</a> 
                                </div>
                            </div>
                    </div>';
