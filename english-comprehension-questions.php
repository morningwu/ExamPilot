	...
	<body>
		...
		<div class="container">
			<div class="row-fluid">
				...
				<div class="span12">
                	<div id="inner_title">
                        <h2 class="text-center">English Comprehension <?php echo " ( ".$level." ) "?></h2>
                       
                        <div class="text-center">
                            <a class="flat-button flat-button-2" href="english-comprehension-new.php?level=<?php echo $studentLevelGet;?>">&larr; Back</a> 
                        </div>
                    </div>
				</div>
			</div><!--/row-->
                       ...
                       //Fecthing the Questions
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                           ...
                           echo  "<div class='question-title'> $question_no . ". $question . "</div> ";
                            ...
                            if(isset($_POST['submit'])){ 
                                if(empty($_POST[$id])){
                                    ...
                                    echo "<p align='center'><a class='btn blue-btn' href='english-comprehension-questions.php?id=".$missionId.'&level='.$studentLevelGet.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType."'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           echo" <tr>
                            ...
                            <div align='center'>
                                 <a class='btn blue-btn' href='english-comprehension-questions.php?id=".$missionId.'&level='.$studentLevelGet.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType."'>Try Again</a>
                            <a href='english-comprehension-new.php?level=".$studentLevelGet."' class='btn blue-btn' name='next'>Other Missions</a>
                            </div>
                            ";
                            //echo ' </div>';
