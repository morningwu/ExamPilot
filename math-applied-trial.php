...
$level          = $_GET['level'];
$questionMaths  = mysql_query("SELECT DISTINCT (`mission_id`),`question_type`,`title` FROM `questions_maths` WHERE `subject` = 'Math' AND `learning_area` = 'AppliedQuestions' AND `level` = '$level' Limit 0,6");
                        ...
                        <img src="_assets/img/english/grammar/grammar-icon-'.$photoNum.'.png" alt="English-Grammar-Icon"/>
                            ...
                            <table>
                                ...
                                <div class="aboutsocial">
                                    <a id="flat-btn" class="flat-button flat-btn-round-3" href="math-applied-questions-trial.php?id='.$missionId.'&assessmenttitle='.$trimmed_title.'&questiontype='.$trimmed_questionType.'&level='.$level.'">做練習 &rarr;</a> 
                                </div>
                            </div>
                    </div>';
