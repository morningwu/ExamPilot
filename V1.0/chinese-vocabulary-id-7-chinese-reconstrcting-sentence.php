                ...
                <div class="span12">
                    <div id="inner_title">
                        ...
                        <span class="right-back-btn">
                            <a class=" btn blue-btn-small" href="chinese-vocabulary.php">Back &rarr;</a> 
                        </span>
                    </div>
                </div>
            </div><!--/row-->
        ...
        <div id="content">
            <div class="container">
                ...
                <!-- Assessment Content Start -->
                    ...
                    <?php include('question/chinese/vocabulary/vocabulary-id-7-chinese-reconstructing-sentences.php');?>
