...
//extracting the questions
    ...
    $learning_points                = "50";
    $questions                      = mysql_query("SELECT * FROM `questions_chinese` WHERE `Mission_id` = '$missionId' and `learning_area` = '$learning_area'");
    $questionsPassage               = mysql_query("SELECT * FROM `questions_chinese` WHERE `Mission_id` = '$missionId' and `learning_area` = '$learning_area'");
				...
				<div class="span12">
                	<div id="inner_title">
                        ...
                        <span class="right-back-btn">
                            <a class=" btn blue-btn-small" href="chinese-vocabulary-new.php">&larr; Back</a> 
                        </span>
                    </div>
				</div>
			</div><!--/row-->
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(empty($_POST[$id])){
                                    ...
                                    echo "<p align='center'><a class='btn blue-btn' href='chinese-vocabulary-question.php?id=".$missionId.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType."'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "<tr>
                            ...
                            <div align='center'>
                                 <a class='btn blue-btn' href='chinese-vocabulary-question.php?id=".$missionId.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType."'>Try Again</a>
