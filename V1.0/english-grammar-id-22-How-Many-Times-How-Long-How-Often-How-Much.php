...
<?php $assessment_title = "Mission 22 : How Many Times / How Long / How Often / How Much";?>
<?php check_login();?>
            ...
            <div class="row">
                ...
                <div class="span12">
                    <div id="inner_title">
                        ...
                        <span><?php echo $assessment_title;?></span>
                        <span class="right-back-btn">
                            <a class=" btn blue-btn-small" href="english-grammar.php">Back &rarr;</a> 
                        </span>
                    </div>
                </div>
            </div><!--/row-->
        ...
        <div id="content">
            <div class="container">
                ...
                <!-- Assessment Content Start -->
                    ...
                    <?php include('question/english/grammar/22-How-Many-Times-How-Long-How-Often-How-Much.php');?>
