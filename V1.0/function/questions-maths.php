...
function add_questions_maths($mission_id,$level,$learning_area,$question_type,$title,$questions,$selection1,$selection2,$selection3,$selection4,$answer,$created_by,$date_of_creation){
