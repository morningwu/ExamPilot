...
$assessment_title = "Mission 11 : Letter Begin with A - 2<br/>(Fill in the Blanks)";
				...
				<div class="span12">
                	<div id="inner_title">
                        ...
                        <span class="right-back-btn">
                            <a class=" btn blue-btn-small" href="english-vocabulary.php">Back &rarr;</a> 
                        </span>
                    </div>
				</div>
			</div><!--/row-->
		...
		<div id="content">
            <div class="container">
                ...
                <!-- Assessment Content Start -->
                    ...
                    <?php include('question/english/vocabulary/vocabulary-id-11-Letter-Begining-with-A-2.php');?>
