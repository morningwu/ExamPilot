...
<?php $assessment_title  = "Mission 1 : About Jupiter"; ?>
<?php check_login();?>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="span12">
                	<div id="inner_title">
                        <h1>English Comprehesnion </h1>
                        <span>About Jupiter</span>
		...
		<div id="content">
            <div class="container">
                ...
                <!-- Assessment Content Start -->
                    ...
                    <?php include('question/english/comprehension/1-jupiter.php');?>
