...
?>
                    <div class="span3 left-side-bar-container">
                        <img src="_assets/img/english/vocabulary/vocabulary-icon-12.png" alt="English-Vocabulary-Icon"/><hr/>
                    <div class="tabbable"> 
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        ...
                        <h4>Select synonyms(同義詞) of the given words</h4>
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                           ...
                           echo '<ul class="no-bullet"><li>'. "<input type=radio     name=\"$id\" value=\"$option1\"> $option1 " . "</li>" .
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-vocabulary-id-12-Synonym.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-vocabulary-id-12-Synonym.php' class='btn blue-btn' name='again'>Try Again</a>
