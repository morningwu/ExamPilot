...
?>
                    <div class="span3 left-side-bar-container">
                       <img src="_assets/img/english/vocabulary/vocabulary-icon-16.png" alt="English-Vocabulary-Icon"/><hr/>
                    <div class="tabbable"> 
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                           ...
                           echo '<ul class="no-bullet"><li>'. "<input type=radio     name=\"$id\" value=\"$option1\"> $option1 " . "</li>" .
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-vocabulary-id-16-Multiple-Vocabulary-Test-4.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-vocabulary-id-16-Multiple-Vocabulary-Test-4.php' class='btn blue-btn' name='again'>Try Again</a>
