...
?>
                    <div class="span3 left-side-bar-container">
                        <img src="_assets/img/english/vocabulary/vocabulary-icon-09.png" alt="English-Vocabulary-Icon"/><hr/>
                    <div class="tabbable"> 
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-vocabulary-id-9-Letter-Begining-With-R-2.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-vocabulary-id-9-Letter-Begining-With-R-2.php' class='btn blue-btn' name='again'>Try Again</a>
