...
?>
                    <div class="span3 left-side-bar-container">
                        <img src="_assets/img/english/comprehension/comprehension-icon-03.png" alt="English-Comprehension-Icon"/><hr/>
                    <div class="tabbable"> 
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        ...
                        <div class="passage">
                            <p>If you visit Japan, you might choose to travel around 
                                the country by shinkansen train. These high-speed trains 
                                connect the major cities of Japan. They are nicknamed “bullet 
                                trains” because they go very fast and have pointy noses like a 
                                bullet.</p>

                            <p>Bullet trains are a good way to travel for several 
                                reasons other than their speed. They are very punctual, often 
                                leaving on time to the second. They are also comfortable. All the seats face forward, and there is plenty of 
                                leg room. Most importantly, bullet trains are very safe. In their 35-year history, there have been only a few 
                                accidents and no deaths.</p>

                            <p>The only downside to bullet trains is that they are expensive. A ticket to travel to another city can 
cost almost as much as an airline ticket would. However, if you fly, you will land at an airport at the edge 
of a city. Train stations are usually right in the middle of a city. This means that it is often more convenient 
to take a bullet train instead of flying, because you will arrive exactly where you want to be.</p>
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-comprehension-id-3-The-Train.php' class='btn blue-btn' name='again'>Try Again</a>
