...
?>
                    <div class="span3 left-side-bar-container">
                       <img src="_assets/img/english/comprehension/comprehension-icon-05.png" alt="English-Comprehension-Icon"/><hr/>
                    <div class="tabbable"> 
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        ...
                        <div class="passage">
                            <p>When traveling in the northern Italy during the hot summer of 1859, a Swiss banker named Henry Dunant witnessed such a horrifying sight that he was inspired to establish the organization which we know today as the Red Cross.</p>

                            <p>The battle of Solferino between Austria and the Franco-Sardinian Alliance had left many men dead,dying and abandoned.Those barely clinging to life were tortured by pain, thirst, searing heat and flies.Deeply moved by this harrowing scene, Dunant felt great compassion and was compelled to act,urging villagers from nearby Castiglione Della Pieve to help care for the injured.In providing this practical support, these people became the first volunteers of the Red Cross.</p>

                            <p>In 1862, Dunant published a book, A Memory of Solferino, in which he claimed that all societies have their vulnerable people and that the combined power of humankind could be harnessed to ease the suffering of such people, all over the world.He suggested forming a neutral relief agency of qualified volunteers to assist all sides during times of conflict.Such an agency could also be deployed in areas where natural disasters destroy lived and communities.He pointed out that suffering does not end when the battle or the storm is over. Help would always be required to assist people in repairing their shattered lives.</p>

                            <p>In 1901, forty-two years after the Battle of Solferino, Henry Dunant was awarded the first Nobel Prize for Peace for his role in founding the International Red Cross.Through the tireless efforts of Henry Dunant and the first members of the Red Cross organization the world has a magnificent relief agency of volunteers who selflessly offer their services in so many way.</p>                            
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            echo '<ul class="no-bullet"><li>'. "<input type=radio     name=\"$id\" value=\"$option1\"> $option1 " . "</li>" .
                                 ...
                                 "<li>"    . "<input type=radio     name=\"$id\" value=\"$option3\"> $option3"  . "</li></ul>";
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-comprehension-id-5-The-International-Red-Cross.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-comprehension-id-5-The-International-Red-Cross.php' class='btn blue-btn' name='again'>Try Again</a>
