...
?>
                    <div class="span3 left-side-bar-container">
                         <img src="_assets/img/english/comprehension/comprehension-icon-01.png" alt="English-Comprehension-Icon"/><hr/>
                    <div class="tabbable"> 
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        ...
                        <div class="passage">
                        <p>Our solar system is believed to be around 4.5 billion years old.It consists of eight planets which orbit 
                        the Sun.The planets,in order from the Sun,are Mercury,Venus,Earth,MArs,Jupiter,Saturn,Uranus and Neptune.</p>

                        <p>Jupiter is the fifth and largest planet in our solar system.Its volume is 1321 times that of Earth.It was named after the Roman king of the gods,which is appropriate since it is the king of the planets ﹣ a gas giant!Its diameter is about 143 000 kilometres,that is over 11 times greater than the Earth's diameter.</p>

                        <p>Because it is so far from the Sun, approximately 750,000,000 kilometers,Jupiter is very cold.The planet is surrounded by three layers of clouds, each made of different substances!Scientists were surprised to find that lightning occurs within these clouds, much the same as lightning occurs during a thunderstorm here on Earth.Jupiter is famous for the 'Great Red Spot', a storm that has been raging for more than 350 years. It can be seen just below Jupiter's equator and looks rather small on the face of the planet.But,just remember how big Jupiter is;the Red spot is actually equivalent in size to three planet Earths!</p>

                        <p>Jupiter is surrounded by the most number of moons compared to any planet in the solar system.It has a total of 63 moons.Some of these are unnamed,but four of them are considered to be quite significant! The first of these moons is called Io.Io has many active volcanoes and lakes of</p><hr/>
                        </div>
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-comprehension-id-1-jupiter.php' class='btn blue-btn' name='again'>Try Again</a>
