...
?>
                    <div class="span3 left-side-bar-container">
                         <img src="_assets/img/english/comprehension/comprehension-icon-07.png" alt="English-Comprehension-Icon"/><hr/>
                    <div class="tabbable"> 
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        ...
                        <div class="passage">
                            <p>Sam：I'm very excited now!Our family are going on a 7-day cruise this Sunday.</p>

                            <p>I packed my suitcases this morning. And i bought a new pair of sunglasses today.But Mum is not very excited.</p>

                            <p>She worry a lost because she has seasickness every time when she travel on a boat.</p>


                            <p>She asked me to check if there any solution to deal with her illness.</p>

                            <p>I checked and find lots of people suffer fro seasick.People suffer from it will fell asleep,dizzy and want to vomit.</p>

                            <p>To cure ourselves from it,drink some water and take a deep breathe, rest more and sleep will be the best solution to cure seasick.Looking at things far will also useful.</p>

                            <p>I'll buy some pills for mum before we step on the cruise,hope mum will be ok in the 7 days.</p>
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-comprehension-id-7-The-Boat-Trip.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-comprehension-id-7-The-Boat-Trip.php' class='btn blue-btn' name='again'>Try Again</a>
