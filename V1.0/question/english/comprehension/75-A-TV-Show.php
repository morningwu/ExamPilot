...
?>
                    <div class="span3 left-side-bar-container">
                        <img src="_assets/img/english/comprehension/comprehension-icon-75.png" alt="English-Comprehension-Icon"/><hr/>
                    <div class="tabbable"> 
...
<img src="_assets/img/question/comprehension/p4/75-the-tv-show/P4_schedule_1.png" alt="Schedule">
<img src="_assets/img/question/comprehension/p4/75-the-tv-show/P4_schedule_2.png" alt="Schedule">
<hr/>
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-comprehension-id-75-A-TV-Show.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-comprehension-id-75-A-TV-Show.php' class='btn blue-btn' name='again'>Try Again</a>
