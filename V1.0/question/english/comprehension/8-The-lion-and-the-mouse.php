...
?>
                    <div class="span3 left-side-bar-container">
                       <img src="_assets/img/english/comprehension/comprehension-icon-08.png" alt="English-Comprehension-Icon"/><hr/>
                    <div class="tabbable"> 
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        ...
                        <div class="passage">
                            <p>A mouse was looking for food in the forest.A lion passed by and caught her.The mouse begged and luckily the lion was kind and let her go.


                                    The mouse flee quickly and disappear in the forest. </p>

                                <p>One week later,the lion was trapped in a net, no matter how hard the lion tried, it cannot break the net and get out from it.It shouted and yelled, hoping it's parents will come and help,but time fly and nobody come.</p>

                                <p>In this moment, the mouse saw the lion,she ran to the net and bite on it. Finally the net broken and the lion flee out from the trap.</p>

                                <p>The Lion, finally thanks the mouse and the mouse said :"this is a return to your kindness!"</p>
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-comprehension-id-8-The-Lion-and-The-Mouse.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-comprehension-id-8-The-Lion-and-The-Mouse.php' class='btn blue-btn' name='again'>Try Again</a>
