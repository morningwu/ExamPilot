...
?>
                    <div class="span3 left-side-bar-container">
                         <img src="_assets/img/english/grammar/grammar-icon-08.png" alt="English-Grammar-Icon"/><hr/>
                    <div class="tabbable"> 
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-grammar-id-8-So-Therefore-Because.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-grammar-id-8-So-Therefore-Because.php' class='btn blue-btn' name='again'>Try Again</a>
