...
?>
                    <div class="span3 left-side-bar-container">
                         <img src="_assets/img/english/grammar/grammar-icon-12.png" alt="English-Grammar-Icon"/><hr/>
                    <div class="tabbable"> 
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            echo '<ul class="no-bullet"><li>'. "<input type=radio     name=\"$id\" value=\"$option1\"> $option1 " . "</li>" .
                                 "<li>"    . "<input type=radio     name=\"$id\" value=\"$option2\"> $option2"  . "</li></ul>";
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-grammar-id-12-Subject-Verb-Agreement-2.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-grammar-id-12-Subject-Verb-Agreement-2.php' class='btn blue-btn' name='again'>Try Again</a>
