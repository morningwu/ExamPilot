...
$mission_type                   = "Fill in The Blanks";
$mission_id                     = 24;
$passing_rate                   = 0.6;
...
?>
                    <div class="span3 left-side-bar-container">
                         <img src="_assets/img/english/grammar/grammar-icon-24.png" alt="English-Grammar-Icon"/><hr/>
                    <div class="tabbable"> 
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        <h2 align="center"><span class="font-orange"><?php if(isset($_POST['submit'])){echo "<h1>".$_SESSION['student_name']."'s Result"."</h1>" ;}else{

                            echo $assessment_title;
                    ...
                    ?>
                        ...
                        <h3>Fill in the Blanks with following sentences</h3>
                            <ol>
                                <li>when he want to send a mail to grandpa</li>
                                <li>when it's in a typhoon day</li>
                                <li>when i'm talking with sam in the class</li>
                                <li>when someone switched off the air-conditioner</li>
                                <li>when she found someone opened her luggage</li>
                                <li>when there is a holiday</li>
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            echo "<input type='text' class='placeholder span4' name='$id' placeholder='Answer Here~'>";
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='english-grammar-id-24-using-when.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='english-grammar-id-24-using-when.php' class='btn blue-btn' name='again'>Try Again</a>
