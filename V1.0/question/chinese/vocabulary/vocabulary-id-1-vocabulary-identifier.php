...
?>
                    <div class="span3 left-side-bar-container">
                       <img src="_assets/img/english/vocabulary/vocabulary-icon-01.png" alt="English-Vocabulary-Icon"/><hr/>
                    <div class="tabbable"> 
                    ...
                    <div class="question-content">
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            echo "<input type='text' class='placeholder span3' name='$id' placeholder='答案'>";
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='chinese-vocabulary-id-1-vocabulary-identifier.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='chinese-vocabulary-id-1-vocabulary-identifier.php' class='btn blue-btn' name='again'>Try Again</a>
