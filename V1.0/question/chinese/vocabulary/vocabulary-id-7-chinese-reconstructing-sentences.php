...
$questions = mysql_query("SELECT * FROM `questions_chinese` WHERE `Mission_id` = '$mission_id' and `learning_area` = '$learning_area'");
$total = mysql_num_rows($questions);
?>
                    <div class="span3 left-side-bar-container">
                       <img src="_assets/img/english/vocabulary/vocabulary-icon-07.png" alt="English-Vocabulary-Icon"/><hr/>
                    <div class="tabbable"> 
                    ...
                    <div class="question-content">
                       ...
                       <?php
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            echo "<input type='text' class='placeholder span3' name='$id' placeholder='答呢到'value='";
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='chinese-vocabulary-id-7-chinese-reconstrcting-sentence.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='chinese-vocabulary-id-7-chinese-reconstrcting-sentence.php' class='btn blue-btn' name='again'>Try Again</a>
                            <a href='english-vocabulary.php' class='btn blue-btn' name='next'>Other Missions</a>
                            </div>
                            ";
                            //echo ' </div>';
                            include ('report.php');
