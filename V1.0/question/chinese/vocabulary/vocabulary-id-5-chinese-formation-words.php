...
?>
                    <div class="span3 left-side-bar-container">
                       <img src="_assets/img/english/vocabulary/vocabulary-icon-05.png" alt="English-Vocabulary-Icon"/><hr/>
                    <div class="tabbable"> 
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(isset($_POST[$id]) == false){
                                    ...
                                    echo "<p align='center'><a href='chinese-vocabulary-id-5-formation-words.php' class='btn blue-btn' name='again'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "</td>
                            ...
                            <div align='center'>
                            <a href='chinese-vocabulary-id-5-formation-words.php' class='btn blue-btn' name='again'>Try Again</a>
