...
if(isset($_SESSION['student_name'])){
    ...
    $questionEnglish        = mysql_query("SELECT DISTINCT (`mission_id`),`question_type`,`title` FROM `questions` WHERE `subject` = 'English' AND `learning_area` = 'Comprehension'");
                        ...
                        <img src="_assets/img/english/comprehension/comprehension-icon-'.$photoNum.'.png" alt="English-Comprehension-Icon"/>
                            ...
                            <table>
                                ...
                                <div class="aboutsocial">
                                    <a class="btn blue-btn-small" href="english-comprehension-questions.php?id='.$missionId.'&assessmenttitle='.$trimmed_title.'&questiontype='.$trimmed_questionType.'">Learn &rarr;</a> 
                                </div>
                            </div>
                    </div>';
