...
if(isset($_SESSION['student_name'])){
    ...
    $questionChinese        = mysql_query("SELECT DISTINCT (`mission_id`),`question_type`,`title` FROM `questions_chinese` WHERE `subject` = 'Chinese' AND `learning_area` = 'Vocabulary'");
                        ...
                        <img src="_assets/img/english/vocabulary/vocabulary-icon-'.$photoNum.'.png" alt="Chinese-Vocabulary-Icon"/>
                            ...
                            <table>
                                ...
                                <div class="aboutsocial">
                                    <a class="btn blue-btn-small" href="chinese-vocabulary-question.php?id='.$missionId.'&assessmenttitle='.$trimmed_title.'&questiontype='.$trimmed_questionType.'">Learn &rarr;</a> 
                                </div>
                            </div>
                    </div>';
