    ...
    <body>
        ...
        <div class="container">
            <div class="row-fluid">
                ...
                <div class="span12">
                    <div id="inner_title">
                        <h2 class="text-center">English Grammar : <?php echo $getTitle;?></h2>
                       
                        <div class="text-center">
                            <a id="flat-btn" class="flat-button flat-button-2" href="english-grammar-trial.php?level=<?php echo $_GET['level'];?>">&larr; Back</a> 
                        </div>
                    </div>
                </div>
            </div><!--/row-->
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(empty($_POST[$id])){
                                    ...
                                    echo "<p align='center'><a class='btn blue-btn' href='english-grammar-question-trial.php?id=".$missionId.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType.'&level='.$level."'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "<tr>
                            ...
                            <a href='english-grammar-trial.php?level=".$level."' class='btn blue-btn' name='next'>Other Missions</a>
                            </div>
                            ";
                            //echo ' </div>';
