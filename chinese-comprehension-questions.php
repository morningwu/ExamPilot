				...
				<div class="span12">
                	<div id="inner_title">
                        ...
                        <div class="text-center">
                            <a id="flat-btn" class="flat-button flat-button-2"  <?php echo 'href="chinese-comprehension.php?level='.$studentLevelGet.'"'?>> &larr; 返回</a> 
                        </div>
                    </div>
				</div>
			</div><!--/row-->
            ...
            <div class="container center">
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        <h2 align="center"><span class="font-orange"><?php if(isset($_POST['submit'])){echo "<h1>".$_SESSION['student_name']."既成績"."</h1>" ;}else{echo "Mission " . $missionId. " : ". $getTitle;}?></span></h2><hr/>
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(empty($_POST[$id])){
                                    ...
                                    echo "<p align='center'><a class='btn blue-btn' href='chinese-comprehension-questions.php?id=".$missionId."&assessmenttitle=".$getTitle."&questiontype=".$questionType."&level=".$studentLevelGet."'>答多次先</a></p>";
                                    exit();
                                }
                           ...
                           "<tr>
                            ...
                            <div align='center'>
                                 <a class='btn blue-btn' href='chinese-comprehension-questions.php?id=".$missionId."&assessmenttitle=".$getTitle."&questiontype=".$questionType."&level=".$studentLevelGet."'>答多次先</a>
                                 <a href='chinese-comprehension.php?level=".$studentLevelGet."' class='btn blue-btn' name='next'>其他任務</a>
