...
include('function/user.php');
    ...
    $level                  = $_GET['level'];
    $questionEnglish        = mysql_query("SELECT DISTINCT (`mission_id`),`question_type`,`title` FROM `questions` WHERE `subject` = 'English' AND `learning_area` = 'Comprehension' AND `level` = '$level' Limit 0,6");
    ...
    <div id="wrapper">
        ...
        <div class="container center">
            <div class="row-fluid">
                <div class="span12">
                    <div id="inner_title">
                    <h2 class="text-center">English  ( Comprehension ) </h2> 
                        ...
                        <img src="_assets/img/english/comprehension/comprehension-icon-'.$photoNum.'.png" alt="English-Comprehension-Icon"/>
                            ...
                            <table>
                                ...
                                <div class="aboutsocial">
                                    <a id="flat-btn" class="flat-button flat-btn-round-3" href="english-comprehension-question-trial.php?id='.$missionId.'&assessmenttitle='.$trimmed_title.'&questiontype='.$trimmed_questionType.'&level='.$level.'">Learn &rarr;</a> 
                                </div>
                            </div>
                    </div>';
