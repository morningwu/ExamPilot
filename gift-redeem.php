			...
			<div class="container">
                ...
                <div class="span3">
					...
					<div class="span9">
						...
						?>
						<img src="_assets/img/gift-redeem-01.png" alt="Gift-Redemption-Logo" />
						<div class="white-bg box-top-fix">
							<h2>換領禮品：<?php echo $giftname;?></h2><hr/>
							<p><span class="font-red">學習點：<?php echo $giftOneLearningPoints;?></span></p>
