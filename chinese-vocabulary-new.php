...
if(isset($_SESSION['studentEmail'])){
    ...
    $questionChinese        = mysql_query("SELECT DISTINCT (`mission_id`),`question_type`,`title` FROM `questions_chinese` WHERE `subject` = 'Chinese' AND `learning_area` = 'Vocabulary' AND `level` = '$studentLevelGet'");
}
	...
	<body>
		...
		<div class="container">
			<div class="row-fluid">
				<div class="span12">
                     <div id="inner_title">
                    <h2 class="text-center">中國語文 - (詞彙練習)1</h2> 
		...
		<div id="content">
			<div class="container">
                ...
                while ($fetch_questions = mysql_fetch_assoc($questionChinese)){
                    ...
                    echo 
                    '<div class="span4 assessment-container">
                        <img src="_assets/img/english/vocabulary/vocabulary-icon-'.$photoNum.'.png" alt="Chinese-Vocabulary-Icon"/>
                            ...
                            <table class="subject-table">
                                ...
                                <div class="btn-container">
                                    <a class="flat-button flat-btn-round-3" href="chinese-vocabulary-question.php?id='.$missionId.'&assessmenttitle='.$trimmed_title.'&questiontype='.$trimmed_questionType.'&level='.$studentLevelGet.'">做練習 &rarr;</a> 
                                </div>
                            </div>
                    </div>';
