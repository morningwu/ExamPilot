...
include('function/user.php');
    ...
    $level          = $_GET['level'];
    $questionMaths  = mysql_query("SELECT DISTINCT (`mission_id`),`question_type`,`title` FROM `questions_maths` WHERE `subject` = 'Math' AND `learning_area` = 'Calculation' AND `level` = '$level' Limit 0,6");
			...
			<div class="row-fluid">
				<div class="span12">
                    ...
                    <div class="text-center">
                       <a id="flat-btn" class="flat-button flat-button-2" href="maths-trial.php?level=<?php echo $_GET['level'];?>"> &larr; 返回</a>  
                    </div>
                </div>
			...
			<div class="container">
                ...
                while ($fetch_questions = mysql_fetch_assoc($questionMaths)){
                    ...
                    '<div class="span4 filterable assessment-container">
                        <img src="_assets/img/english/grammar/grammar-icon-'.$photoNum.'.png" alt="Maths-Calculation-Icon"/>
                            ...
                            <table>
                                ...
                                <div class="aboutsocial">
                                    <a id="flat-btn" class="flat-button flat-btn-round-3" href="math-calculation-questions-trial.php?id='.$missionId.'&assessmenttitle='.$trimmed_title.'&questiontype='.$trimmed_questionType.'&level='.$level.'">做練習 &rarr;</a> 
                                </div>
                            </div>
                    </div>';
