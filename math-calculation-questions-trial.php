	...
	<body>
        ...
        <div class="container">
            <div class="row-fluid">
                ...
                <div class="span12">
                    <div id="inner_title">
                        <h2 class="text-center">四則運算 : <?php echo $getTitle;?></h2>
                       
                        <div class="text-center">
                            <a id="flat-btn" class="flat-button flat-button-2" href="math-calculation-trial.php?level=<?php echo $_GET['level'];?>">&larr; Back</a> 
                        </div>
                    </div>
                </div>
            </div><!--/row-->
                                ...
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo '<span class="font-red">'. $learning_points . '</div>';?></td>
                                        </tr>
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(empty($_POST[$id])){
                                    ...
                                    echo "<p align='center'><a class='btn blue-btn' href='math-calculation-questions-trial.php?id=".$missionId.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType.'&level='.$level."'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "<tr>
                            ...
                            <a href='math-calculation-trial.php?level=".$level."' class='btn blue-btn' name='next'>其他練習</a>
                            </div>
                            ";
                            //echo ' </div>';
