	       		...
	       		<div class="row-fluid">
	       			<div class="index-center">
		           	  ...
		           	  <div class="index-left-container">
		           	  	<h1 class="text-center"><span class="index-chinese-font font-shadow">練習 ‧ 報告 ‧ 獎賞</span></h1>
		           	  	<h3 class="text-center"><span class="index-chinese-font font-shadow">練習校內所學．追蹤學習進度</span></h3>
		           	  </div>
		           	  </div>
		...
		<div id="content">
			...
			<div class="main">
				<div class="row-fluid">
					...
					<div class="row-fluid">
						<div class="span3 center">
							<img src="_assets/img/index-icon-02.png" alt="PrimaryAssessmentLearningReport" width="150px" height="150px"/>
						</div>
						<div class="span3 ">
							<h2>學習報告</h2>
						...
						<div class="row-fluid">
						<div class="span3 center">
							<img src="_assets/img/index-icon-03.png" alt="LearningPoints" width="150px" height="150px"/>
						</div>
						<div class="span3">
							<h2>學習獎勵</h2>
