				...
				<div class="span12">
                	<div id="inner_title">
                        ...
                        <span class="right-back-btn">
                            <a class=" btn blue-btn-small" href="kumon-calculation.php?level=<?php echo $studentLevelGet;?>">&larr; 返回</a> 
                        </span>
                    </div>
				</div>
			</div><!--/row-->
		...
		<div id="content">
            <div class="container">
                ...
                <!-- Assessment Content Start -->
                      ...
                      <?php
                      $photoNum = $missionId;
                      echo '<img src="_assets/img/kumon.png" alt="Sponsored Content" /><hr/>';
                      ?>
                ...
                <div class="span8 question-content-container">
                    <div class="question-content">
                        <h2 align="center"><span class="font-orange"><?php if(isset($_POST['submit'])){echo "<h1>".$_SESSION['student_name']."'s Result"."</h1>" ;}else{echo "任務 " . $missionId. " : ". $getTitle;}?></span></h2><hr/>
                        ...
                        while($row = mysql_fetch_assoc($questions)){
                            ...
                            if(isset($_POST['submit'])){ 
                                if(empty($_POST[$id])){
                                    ...
                                    echo "<p align='center'><a class='btn blue-btn' href='math-calculation-question.php?id=".$missionId.'&level='.$studentLevelGet.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType."'>Try Again</a></p>";
                                    exit();
                                }
                           ...
                           "<tr>
                            ...
                            <div align='center'>
                                <a class='btn blue-btn' href='math-calculation-question.php?id=".$missionId.'&level='.$studentLevelGet.'&assessmenttitle='.$getTitle.'&questiontype='.$questionType."'>再玩多次</a>
                            <a href='math-calculation.php?level=".$studentLevelGet."' class='btn blue-btn' name='next'>其他練習</a>
                            </div>
                            ";
                            //echo ' </div>';
