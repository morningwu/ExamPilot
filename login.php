...
if(isset($_POST['email'],$_POST['password'])){
  ...
  if(empty($errors)){
  	...
  	//Selecting student Level
    $studentLevel 				= $set_login_name['student_level'];
    if($studentLevel == "Primary 1"){
    	$studentLevelFetch = "P.1";
    }elseif($studentLevel == "Primary 2"){
    	$studentLevelFetch = "P.2";
    }elseif($studentLevel == "Primary 3"){
    	$studentLevelFetch = "P.3";
    }elseif($studentLevel == "Primary 4"){
    	$studentLevelFetch = "P.4";
    }elseif($studentLevel == "Primary 5") {
    	$studentLevelFetch = "P.5";
    }elseif($studentLevel == "Primary 6"){
    	$studentLevelFetch = "P.6";
    }
     	
   echo '<meta HTTP-EQUIV="REFRESH" content="0; url=learning.php?level='.$studentLevelFetch.'">';
   // die();
  }
}
